...
public class MatrixAccionesSemanticas {
	...
	private MatrixAccionesSemanticas() {
		...
		matrixAccionesSemanticas[17] = new AccionSemantica[]{ AS3,  AS3,  AS3, 	 AS3,	 AS3,	   AS3,	   AS3,	 AS3,	 AS3,	 AS3,	 AS3,	 AS3,	 AS3,	 AS3,	 AS3,	 AS3,	 AS3, 	 AS3, 	 AS3, 	 AS3, 	 AS3, 	 AS3, 	 AS10, 	AS3, 	AS3,	AS3,   AS3,   AS3,	  ASE, 	 AS3, 	 AS3 };
		matrixAccionesSemanticas[18] = new AccionSemantica[]{ AS3, AS11, AS11,   AS3,   AS11,	  AS11,   AS11,  AS11,   AS3,   AS11,   AS11,   AS11,   AS11,   AS11,   AS11,   AS11,   AS11,   AS11,   AS11,   AS11,   AS11,   AS11,   AS11,   AS11,  AS11,   AS11,  AS11,  AS11,   AS11,  AS11,   AS11 };
	} 
