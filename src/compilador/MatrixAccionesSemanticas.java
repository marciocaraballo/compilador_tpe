...
public class MatrixAccionesSemanticas {
	...
	public MatrixAccionesSemanticas(TablaDeSimbolos ts, TablaPalabrasReservadas tpr, Logger logger) {
		...
		matrixAccionesSemanticas[8] = new AccionSemantica[]{ AS3,  AS3,  AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,    AS3,   AS10,    AS3,   AS3,   ASE,    AS3,   ASE,		ASE};
